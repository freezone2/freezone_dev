...
define('NAVIGATION','
    <div class="about-nav nav-fullpage">
        <ul>
            ...
            <li><a href="#fly">Полет в <br /> аэротрубе</a></li>
            <li><a href="#trainers">Уникальный <br /> тренерский <br /> состав</a></li>
            <li><a href="#school">Школа</a></li>
            <li><a href="#hotel">Гостиница</a></li>
            <li><a href="#cafe">Кафе</a></li>
            <li><a href="#vr">VR полигон</a></li>
        </ul>
    </div>
');
...
$APPLICATION->SetPageProperty("title", "Аэродинамическая труба Freezone");
$APPLICATION->SetPageProperty("description", "Аэродинамическая труба фризон – это комплекс, в котором можно пройти обучение по спортивным дисциплинам для аэродинамической трубы.");
$APPLICATION->SetPageProperty("keywords", "Аэротруба, полет в аэродинамической трубе, freezone, фризон");
...
?>
    ...
    <section class="section about-page about-masthead">
        <div class="site-wrapper">
            <div class="site-wrapper-in">
				...
				<p class="about-title"><?echo COption::GetOptionString( "askaron.settings", "UF_ABOUT_TITLE" );?></p>
            </div>
        </div>
        <div class="slide-img">
            <div class="site-wrapper">
	...
	<div id="trainers">
	<? $APPLICATION->IncludeComponent("bitrix:news.list", "about-our_team", Array(
			"DISPLAY_DATE" => "N",
			"DISPLAY_NAME" => "Y",
			"DISPLAY_PICTURE" => "Y",
			"DISPLAY_PREVIEW_TEXT" => "Y",
