...
$APPLICATION->SetTitle("Фризон");
$APPLICATION->SetPageProperty("description", "Freezone – полет в аэротрубе в Москве. Фризон – самая большая аэротруба в Москве. В продаже подарочные сертификаты!");
$APPLICATION->SetPageProperty("title", "Фризон, полеты в аэротрубе в Москве, Freezone");
$APPLICATION->SetPageProperty("keywords", "Аэротруба, аэродинамическая труба, полет в аэротрубе, москва, симферопольское шоссе");
...
<?if(NEW_DES == 1){?>
    ...
    <section class="section text-section">
        <div class="section-wrap container">
			...
			<p> <a target="_blank" href="https://www.tripadvisor.ru/Attraction_Review-g2323955-d7034200-Reviews-FREEZONE_Aerodynamic_Complex-Moscow_Oblast_Central_Russia.html"><img src="https://www.tripadvisor.ru/img/cdsi/img2/awards/CoE2017_WidgetAsset-14348-2.png" alt="TripAdvisor" class="widCOEImg" id="CDSWIDCOELOGO"></a>
			</p>
        </div>
    </section>
