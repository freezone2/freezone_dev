...
$MESS['ERROR_ENTER_NAME'] = 'Введите корректное имя';
$MESS['ERROR_ENTER_EMAIL'] = 'Введите корректный адрес электронной почты';
$MESS['ERROR_ENTER_PHONE'] = 'Введите корректный телефон';
$MESS['FIELD_MESSAGE'] = 'Сообщение';
$MESS['FIELD_NAME'] = 'Имя';
$MESS['FIELD_PHONE'] = 'телефон';
$MESS['SEND'] = 'Отправить';
$MESS['SEND'] = 'Отправить';
