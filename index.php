...
?>
	...
	<h1 class="home_header">Полет в аэротрубе вместе с FreeZone</h1>
            ...
            <div class="container">
                <div class="row adv-list">
                    <div class="adv-item">
                        ...
                        <span>Самая большая полетная зона в мире и самая большая аэротруба в Москве и Восточной Европе</span>
                    </div>
                    <div class="adv-item">
                        <span class="image"><img src="/local/templates/main/images/advantage/2.png" alt=""></span>
                        <span>Хорошее проф. обучение и практика в дисциплинах парашютного и трубного спорта</span>
                    </div>
                    <div class="adv-item">
                ...
                <div class="row adv-list adv-list-sec">
                    ...
                    <div class="adv-item">
                        ...
                        <span>Визовое сопровождение на полеты в аэродинамической трубе в Москве</span>
                    </div>
                    <div class="adv-item">
                        <span class="image"><img src="/local/templates/main/images/advantage/10.png" alt=""></span>
                        <span>Аэродинамическая труба FreeZone – это полет с уникальным тренерским составом</span>
                    </div>
                    <div class="adv-item">
                        <span class="image"><img src="/local/templates/main/images/advantage/11.png" alt=""></span>
                        <span>Две большие аэротрубы в Москве производства американской компании</span>
                    </div>
                </div>
            </div>
        </div>
